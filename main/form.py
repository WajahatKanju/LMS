...
class SettingsForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column('selected_school', css_class='form-group col-md-6'),
                Column('selected_class', css_class='form-group col-md-6'),
            ),
            Row(
                Column('student_changes', css_class='form-group col-md-6'),
            ...
            Row(
                Column('marks_lock_changes', css_class='form-group col-md-6'),
            ),
